...
letter3 = "5.	вёрстка адаптивная: +10 \n 6.	есть адаптивное бургер-меню. (меню на десктопном разрешении не делал, т к содержание блоков и оно едва ли там нужно. Сам же бургер появляется при уменьшении ширины экрана) +10\n",
